...
"You will need to setup a web-readable directory (outside of your web space is better). Then create a way to upload images to that directory" => "Ha bekapcsoljuk a Kötegelt könyvtár feltöltést akkor létre kell hoznunk egy weben keresztül olvasható könyvtárat, lehetőleg a webes könyvtárterületen kívűl. Ezután hozzunk létre egy módszert a feltöltés végrehajtására (scp, ftp vagy más protokoll)",
"Rankings" => "Rangsor",
"Polls" => "Szavazások",
