...
"You will need to setup a web-readable directory (outside of your web space is better). Then create a way to upload images to that directory" => "디렉터리 일관 로딩을 활성화한 경우, 웹에서 읽기 가능한 디렉터리를 설정해야 합니다 (귀하의 웹 공간의 외부가 더 좋습니다). 그리고 해당 디렉터리에 scp, ftp 혹은 다른 프로토콜로 그림을 업로드할 방법을 설정합니다",
"Rankings" => "순위",
...
"Maximum number of terms to be generated. This value may need to be increased in the case of \"Terms per query limit is reached\" espescially with wildcard, range and fuzzy searches" => "생성될 조건의 최대 수. \" 질의 당 조건 제한에 도달했습니다\" 라는 오류를 얻게 되는 경우, 특별히 와일드카드, 범위 및 퍼지 검색의 경우, 이 값의 증가를 시도해 보십시오",
