...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_61263eeb53bb25_43521112',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cd45fd5584c03917a28a8b0095cee7500e48e19d' => 
    array (
...
function content_61263eeb53bb25_43521112 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('wikiplugin', array('_name'=>'googleanalytics','account'=>$_smarty_tpl->tpl_vars['prefs']->value['site_google_analytics_account'],'group_option'=>$_smarty_tpl->tpl_vars['prefs']->value['site_google_analytics_group_option'],'groups'=>$_prefixVariable9));
$_block_repeat=true;
echo smarty_block_wikiplugin(array('_name'=>'googleanalytics','account'=>$_smarty_tpl->tpl_vars['prefs']->value['site_google_analytics_account'],'group_option'=>$_smarty_tpl->tpl_vars['prefs']->value['site_google_analytics_group_option'],'groups'=>$_prefixVariable9), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
$_block_repeat=false;
echo smarty_block_wikiplugin(array('_name'=>'googleanalytics','account'=>$_smarty_tpl->tpl_vars['prefs']->value['site_google_analytics_account'],'group_option'=>$_smarty_tpl->tpl_vars['prefs']->value['site_google_analytics_group_option'],'groups'=>$_prefixVariable9), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('wikiplugin', array('_name'=>'piwik','code'=>$_smarty_tpl->tpl_vars['prefs']->value['site_piwik_code'],'group_option'=>$_smarty_tpl->tpl_vars['prefs']->value['site_piwik_group_option'],'groups'=>$_prefixVariable10));
$_block_repeat=true;
echo smarty_block_wikiplugin(array('_name'=>'piwik','code'=>$_smarty_tpl->tpl_vars['prefs']->value['site_piwik_code'],'group_option'=>$_smarty_tpl->tpl_vars['prefs']->value['site_piwik_group_option'],'groups'=>$_prefixVariable10), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
$_block_repeat=false;
echo smarty_block_wikiplugin(array('_name'=>'piwik','code'=>$_smarty_tpl->tpl_vars['prefs']->value['site_piwik_code'],'group_option'=>$_smarty_tpl->tpl_vars['prefs']->value['site_piwik_group_option'],'groups'=>$_prefixVariable10), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
