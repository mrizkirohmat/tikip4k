...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_61264c49eedd37_17261259',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9e4b21f28ad360ba094a6b6d451bd665d0accb4a' => 
    array (
...
function content_61264c49eedd37_17261259 (Smarty_Internal_Template $_smarty_tpl) {
			...
			<div class="form-group row mx-0">
				...
				<div class="col-sm-7">
					<select name="type" class="findtypes form-control form-control-sm">
						...
						<?php
$__section_t_0_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['types']->value) ? count($_loop) : max(0, (int) $_loop));
				...
				<div class="col-sm-7">
					<span class="findlang">
						<select name="lang" class="in form-control form-control-sm">
							...
							<?php
$__section_ix_1_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['languages']->value) ? count($_loop) : max(0, (int) $_loop));
